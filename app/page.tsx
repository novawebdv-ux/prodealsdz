  ...
  const faqs = [
    {
      ...
      answer: 'بكل بساطة! اختر المنتج الذي تريده، اضغط على "شراء الآن"، سجل الدخول بحساب Google، ثم ادفع عبر بريدي موب او الشيك. بعد تأكيد الدفع، ستحصل على المنتج فوراً.'
    },
    {
      question: 'ما هي طرق الدفع المتاحة؟',
      answer: 'نقبل الدفع عبر بريدي موب او بالشيك. بعد الشراء، سترسل لنا صورة وصل الدفع للمراجعة والموافقة.'
    },
    {
      question: 'كيفية اصور الوصل و ارسله؟',
      answer: 'اذا دفعت بالشيك سيعطونك وصل الدفع قم بتصويره و ارسله مع الطلب. اذا دفعت ببريدي موب ارسل الوصل الى ايميل تمتلكه، ستصلك رسالة للوصل في بريدك، خذ لقطة شاشه له يجب ان تكون واضحة، ارفعها في الطلب و ارسله.'
    }
  ]
